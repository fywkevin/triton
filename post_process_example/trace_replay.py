...
loaded_profile_mem_int32 = torch.load('profile_mem.pth')
profile_mem = loaded_profile_mem_int32.to(torch.uint32)
pconfig = IntraKernelConfig(num_warps=8, proton_slots=2048)
dump_chrome_trace(132, pconfig, profile_mem, "chrome_trace.json", None)
